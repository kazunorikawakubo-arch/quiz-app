const quizData = [
  ...
  { kanji: "哀哀父母", reading: "あいあいふぼ", meaning: "子を育てる苦労を重ねてくれた父母への感謝と、死別した悲しみ。", category: "あ行" },
  { kanji: "握髪吐哺", reading: "あくはつとほ", meaning: "優秀な人材を求めるあまり、食事や洗髪の途中でもすぐに迎えること。", category: "あ行" },
  { kanji: "按兵不動", reading: "あんぺいふどう", meaning: "軍隊を進発させずにおくこと。好機を待って行動を起こさないこと。", category: "あ行" },
  { kanji: "一衣帯水", reading: "いちいたいすい", meaning: "一本の帯のように狭い川や海を隔てて、隣接していることのたとえ。", category: "あ行" },
  { kanji: "一饋十起", reading: "いっきじっき", meaning: "訪ねてくる賢者を迎えるため、一回の食事中に何度も立ち上がること。", category: "あ行" },
  { kanji: "一国一城", reading: "いっこくいちじょう", meaning: "一国の主として城を持つこと。他からの干渉を受けずに独立していること。", category: "あ行" },
  { kanji: "一気呵成", reading: "いっきかせい", meaning: "一息に文章を書き上げたり、物事を一気に仕上げたりすること。", category: "あ行" },
  { kanji: "一念発起", reading: "いちねんほっき", meaning: "ある事を成し遂げようと決意を固めること。", category: "あ行" },
  { kanji: "一網打尽", reading: "いちもうだじん", meaning: "一網で魚を全部捕えるように、悪人などを一度に全員捕まえること。", category: "あ行" },
  { kanji: "一目瞭然", reading: "いちもくりょうぜん", meaning: "ひと目見ただけではっきりと分かるさま。", category: "あ行" },
  ...
  { kanji: "苛政猛於虎", reading: "かせいもうおとら", meaning: "厳しい悪政は、人を殺す猛虎よりも恐ろしい。", category: "か行" },
  { kanji: "快刀乱麻", reading: "かいとうらんま", meaning: "こじれた問題や処理の難しい事態をみごとに解決すること。", category: "か行" },
  { kanji: "戒慎恐懼", reading: "かいしんきょうく", meaning: "己を戒め慎み、かしこまり恐れること。", category: "か行" },
  { kanji: "街談巷説", reading: "がいだんこうせつ", meaning: "世間のおしゃべりや流言飛語。噂話。", category: "か行" },
  { kanji: "画蛇添足", reading: "がだてんそく", meaning: "余計な付け足しをして、かえって台無しにすること。", category: "か行" },
  { kanji: "汗牛充棟", reading: "かんぎゅうじゅうとう", meaning: "蔵書が非常に多いことのたとえ。", category: "か行" },
  { kanji: "管鮑之交", reading: "かんぽうのこう", meaning: "利害を超えた非常に深い友情のたとえ。", category: "か行" },
  { kanji: "機略縦横", reading: "きりゃくじゅうおう", meaning: "計略を状況に応じて自由自在にめぐらすこと。", category: "か行" },
  { kanji: "奇貨可居", reading: "きかかきょ", meaning: "絶好の機会を利用して利益を得ること。", category: "か行" },
  { kanji: "窮鼠猫噛", reading: "きゅうそねこをかむ", meaning: "追い詰められた弱者が、強者に必死の反撃を試みること。", category: "か行" },
  ...
  { kanji: "左右顧眄", reading: "さゆうこめん", meaning: "ためらって周囲の様子をうかがうこと。", category: "さ行" },
  { kanji: "三顧之礼", reading: "さんこのれい", meaning: "目上の人が礼を尽くして賢者を何度も招くこと。", category: "さ行" },
  { kanji: "山千海千", reading: "さんせんかいせん", meaning: "世間の経験が豊富で、したたかで狡猾なこと。", category: "さ行" },
  { kanji: "自家撞着", reading: "じかどうちゃく", meaning: "自分の言動や主張の辻褄が合わないこと。", category: "さ行" },
  { kanji: "獅子奮迅", reading: "ししふんじん", meaning: "ライオンのように猛烈な勢いで奮闘すること。", category: "さ行" },
  { kanji: "自縄自縛", reading: "じじょうじばく", meaning: "自分の言葉や行動によって自分自身が動けなくなること。", category: "さ行" },
  { kanji: "七顛八起", reading: "しちてんはっき", meaning: "何度失敗しても諦めずに立ち上がること。", category: "さ行" },
  { kanji: "疾風迅雷", reading: "しっぷうじんらい", meaning: "素早く猛烈な勢いで行動することのたとえ。", category: "さ行" },
  { kanji: "首鼠両端", reading: "しゅそりょうたん", meaning: "どちらに付くか決めかねて、ためらっているさま。", category: "さ行" },
  { kanji: "神出鬼没", reading: "しんしゅつきぼつ", meaning: "自由自在に現れたり消えたりして、居場所がつかめないさま。", category: "さ行" },
  ...
  { kanji: "大義名分", reading: "たいぎめいぶん", meaning: "人のとるべき道や、行動の正当な根拠。", category: "た行" },
  { kanji: "他山之石", reading: "たざんのいし", meaning: "他人の誤りや劣った言動も、自分の修養の参考になることのたとえ。", category: "た行" },
  { kanji: "単刀直入", reading: "たんとうちょくにゅう", meaning: "前置きを省いて、いきなり本題に入ること。", category: "た行" },
  { kanji: "知者楽水", reading: "ちしゃらくすい", meaning: "知者は真理に達しており、滞りがないので水を愛好する。", category: "た行" },
  { kanji: "中謀迭用", reading: "ちゅうぼうてつよう", meaning: "中の良いはかりごとを互いに採用すること。", category: "た行" },
  { kanji: "長目飛耳", reading: "ちょうもくひじ", meaning: "観察力が鋭く、遠くの情報を素早く集める能力。", category: "た行" },
  { kanji: "直情径行", reading: "ちょくじょうけいこう", meaning: "自分の感情のままにそのまま行動すること。", category: "た行" },
  { kanji: "痛快無比", reading: "つうかいむひ", meaning: "この上なく胸がすっとするさま。", category: "た行" },
  { kanji: "天涯孤独", reading: "てんがいこどく", meaning: "身寄りが一人もおらず、身一つで暮らすこと。", category: "た行" },
  { kanji: "当仁不譲", reading: "とうじんふじょう", meaning: "仁を行うには、どんな相手にも遠慮しないこと。", category: "た行" },
  ...
  { kanji: "温故知新", reading: "おんこちしん", meaning: "昔の教えや歴史を研究して、新しい知識や考え方を得ること。（な行便宜配置）", category: "な行" },
  { kanji: "内清外直", reading: "ないせいがいちょく", meaning: "心の中が清らかで、態度がまっすぐで正直なさま。", category: "な行" },
  { kanji: "難攻不落", reading: "なんこうふらく", meaning: "攻めるのが難しく、容易に陥落しないこと。", category: "な行" },
  { kanji: "南柯之一夢", reading: "なんかのいちむ", meaning: "人生の栄華が儚いことのたとえ。", category: "な行" },
  { kanji: "猫鼠同眠", reading: "びょうそどうみん", meaning: "役人と悪人がグルになって悪事を働くこと。", category: "な行" },
  ...
  { kanji: "背水之陣", reading: "はいすいのじん", meaning: "後がない絶体絶命の状況で全力を尽くすこと。", category: "は行" },
  { kanji: "破竹之勢", reading: "はちくのいきおい", meaning: "猛烈な勢いでとどまることなく進むさま。", category: "は行" },
  { kanji: "反面教師", reading: "はんめんきょうし", meaning: "悪い手本として学ぶ対象となる人や事柄。", category: "は行" },
  { kanji: "悲憤慷慨", reading: "ひふんこうがい", meaning: "悲しみ憤り、悔しがってため息をつくこと。", category: "は行" },
  { kanji: "不撓不屈", reading: "ふとうふくつ", meaning: "どんな困難にあっても決してくじけないこと。", category: "は行" },
  ...
  { kanji: "無為自然", reading: "むいしぜん", meaning: "人為的な手を加えず、ありのままに生きること。", category: "ま行" },
  { kanji: "明哲保身", reading: "めいてつほしん", meaning: "賢く世の処し方を心得て、身を危険にさらさないこと。", category: "ま行" },
  { kanji: "無物相之", reading: "むぶつそうし", meaning: "何の妨げもなく互いに助け合うこと。", category: "ま行" },
  ...
  { kanji: "夜郎自大", reading: "やろうじだい", meaning: "自分の器量の小ささを知らずに威張ること。", category: "や行" },
  { kanji: "唯我独尊", reading: "ゆいがどくそん", meaning: "自分だけが優れていると思い上がること。", category: "や行" },
  ...
  { kanji: "藍糸之交", reading: "らんしのこう", meaning: "非常に親しい友情の結びつき。", category: "ら行" },
